...
RunConfiguration.setExecutionSettingFile('C:\\Users\\tester-3\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Video adding 10 scenes (tests)\\20190708_165837\\execution.properties')
...
WebUI.doubleClick(findTestObject('Page_Reevio Video Maker/Video adding/label_Food'))
...
WebUI.doubleClick(findTestObject('Page_Reevio Video Maker/Video adding/a_USE_page-link'))
...
WebUI.doubleClick(findTestObject('Page_Reevio Video Maker/Video adding/label_People'))
...
WebUI.doubleClick(findTestObject('Page_Reevio Video Maker/Video adding/label_Sport'))
...
WebUI.doubleClick(findTestObject('Page_Reevio Video Maker/Video adding/label_Tech'))
...
WebUI.doubleClick(findTestObject('Page_Reevio Video Maker/Video adding/label_Business'))
...
WebUI.doubleClick(findTestObject('Page_Reevio Video Maker/Video adding/label_Medical'))
...
''', 'Test Cases/Video adding 10 scenes (tests)', new TestCaseBinding('Test Cases/Video adding 10 scenes (tests)',[:]), FailureHandling.STOP_ON_FAILURE , false)
