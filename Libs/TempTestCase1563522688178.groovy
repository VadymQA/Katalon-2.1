...
RunConfiguration.setExecutionSettingFile('C:\\Users\\tester-3\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Scenes adding (15 scenes) if-else\\20190719_105128\\execution.properties')
...
'Go to scenes menu'
not_run: WebUI.click(findTestObject('Page_Reevio Video Maker/div_Add Scene'))

not_run: WebUI.waitForPageLoad(5)

not_run: WebUI.delay(2)

not_run: WebUI.focus(findTestObject('Page_Reevio Video Maker/div_Go to editor_overlay-AddScens'))

not_run: WebUI.waitForElementVisible(findTestObject('Page_Reevio Video Maker/li_Go to editor_add-scene-btn'), 4)

//WebUI.click(findTestObject('Page_Reevio Video Maker/li_Go to editor_add-scene-btn'))
not_run: WebUI.delay(2)

not_run: WebUI.focus(findTestObject('Page_Reevio Video Maker/div_Scene 1_overlay-AddScens'))

not_run: WebUI.waitForElementVisible(findTestObject('Page_Reevio Video Maker/li_Scene 1_add-scene-btn'), 4)

not_run: WebUI.click(findTestObject('Page_Reevio Video Maker/li_Scene 1_add-scene-btn'))

not_run: WebUI.delay(1)

not_run: WebUI.focus(findTestObject('Page_Reevio Video Maker/div_Scene 2_overlay-AddScens'))

not_run: WebUI.waitForElementVisible(findTestObject('Page_Reevio Video Maker/li_Scene 2_add-scene-btn'), 4)

not_run: WebUI.click(findTestObject('Page_Reevio Video Maker/li_Scene 2_add-scene-btn'))

not_run: WebUI.delay(1)

not_run: WebUI.focus(findTestObject('Page_Reevio Video Maker/div_Scene 3_overlay-AddScens'))

not_run: WebUI.waitForElementVisible(findTestObject('Page_Reevio Video Maker/li_Scene 3_add-scene-btn'), 4)

not_run: WebUI.click(findTestObject('Page_Reevio Video Maker/li_Scene 3_add-scene-btn'))

not_run: WebUI.delay(1)

not_run: WebUI.focus(findTestObject('Page_Reevio Video Maker/div_Scene 4_overlay-AddScens'))

not_run: WebUI.waitForElementVisible(findTestObject('Page_Reevio Video Maker/li_Scene 4_add-scene-btn'), 4)

not_run: WebUI.click(findTestObject('Page_Reevio Video Maker/li_Scene 4_add-scene-btn'))

not_run: WebUI.delay(1)

not_run: WebUI.focus(findTestObject('Page_Reevio Video Maker/div_Scene 5_overlay-AddScens'))

not_run: WebUI.waitForElementVisible(findTestObject('Page_Reevio Video Maker/li_Scene 5_add-scene-btn'), 4)

not_run: WebUI.click(findTestObject('Page_Reevio Video Maker/li_Scene 5_add-scene-btn'))

not_run: WebUI.delay(1)

not_run: if (WebUI.verifyElementVisibleInViewport(findTestObject('Page_Reevio Video Maker/div_Scene 6_overlay-AddScens'), 
    1) == true) {
...
if (WebUI.verifyElementVisibleInViewport(findTestObject('Page_Reevio Video Maker/div_Scene 15_overlay-AddScens'), 1) == 
true) {
    WebUI.focus(findTestObject('Page_Reevio Video Maker/div_Scene 15_overlay-AddScens'))

    WebUI.waitForElementVisible(findTestObject('Page_Reevio Video Maker/li_Scene 15_add-scene-btn'), 5)
